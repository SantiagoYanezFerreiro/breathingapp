...
export default function About() {
  return (
    <div className="about-section-container">
      ...
      <h2 className="text-section-heading">Regular Intervals</h2>
      <p classname="text-section-content">
      ...
      <h2 className="text-section-heading">Box Breathing</h2>
      <p classname="text-section-content">
      ...
      <h2 className="text-section-heading">4-7-8 Program</h2>
      <p classname="text-section-content">
      ...
      <h2 className="text-section-heading">Breathing Hold</h2>
      <p classname="text-section-content">
